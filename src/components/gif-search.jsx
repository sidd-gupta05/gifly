...
const GifSearch = () => {
  ...
  return (
    <div className='flex relative'>
        ...
        placeholder='Search all the GIFs and Sticker and also Text'
        ...
        <button
        onClick = {searchGIFs}
        className='bg-gradient-to-t from-pink-600 to-pink-400 text-white px-4 py-2 rounded-tr rounded-br'
        >
